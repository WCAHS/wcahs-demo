...
INSERT INTO faq (section, question, answer, sort_order) VALUES
  ...
  ('general', 'What is the Barn Cat Program?', 'Some cats aren''t suited for indoor living but thrive with a purpose. Our Barn Cat Program places spayed/neutered, vaccinated cats with farm families for a donation. They keep barns mouse-free while enjoying outdoor life. Contact us if you''re interested.', 4);
